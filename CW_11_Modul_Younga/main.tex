...
Porównując z wartościami tabelarycznymi (uwzględniając niepewność rozszerzoną) mamy 
    \[\Delta E_{stali} = 210 - 150,55 = 59,45>2*4,06=8,12\: [GPa]\]
    \[\Delta E_{mosiadz} = 100 - 26,0 = 74 > 2*6,6=13,2\: [GPa]\]
Wyniki pomiarów nie mieszczą się w zakresie niepewności rozszerzonej, co dokładniej jest opisane we wnioskach.
\subsection{Wnioski}
\begin{itemize}
